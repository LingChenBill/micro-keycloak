...
@SpringBootTest(webEnvironment= SpringBootTest.WebEnvironment.DEFINED_PORT, classes = {AuthzRestSpringBootApplication.class})
public class AuthzRestSpringBootApplicationTest {

    @BeforeClass
    public static void setup() throws IOException {
        TestsHelper.baseUrl = "http://localhost:8180";
     ...
     *
     * @param resourceId the permission request
